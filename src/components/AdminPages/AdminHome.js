...
const AdminHome = () => {
   ...
   return (
      <div className=' w-full  md:my-[6rem] my-[3rem]'>
         ...
         <div className=' mx-auto grid md:grid-cols-4 p-2 gap-6'>
         ...
         <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg bg-slate-200 border border-1 hover:scale-105 duration-300'>
            ...
            <div className='text-center font-medium'>
               <ul>
                  <li className='py-4 bg-[#eb4d5f] text-white border-4 font-semibold my-3 rounded-2xl hover:bg-white hover:text-[#eb4d5f] hover:border-[#eb4d5f]' >View FeedBacks</li>
               </ul>
            </div>
         </div>
